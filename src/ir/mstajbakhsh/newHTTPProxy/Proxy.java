 ...
 *  Date:			02/04/2017
 *  Repository:     https://github.com/stefano-lupo/Java-Proxy-Server
 */

import ir.mstajbakhsh.ITunnelStatus;
import ir.mstajbakhsh.OnionProxy;
 ...
 */
public class Proxy extends OnionProxy implements Runnable {
     ...
     */
    public Proxy(int port, ITunnelStatus status) {
        super("127.0.0.1", port, status);
        this.status = status;
